...
$(document).ready(function() {
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            {extend:'excel',title: 'SIMPERTI',className: 'btn btn-primary'}, 
            {extend:'pdf',title: 'SIMPERTI',className: 'btn btn-primary'}, 
            {extend:'print',title: 'SIMPERTI',className: 'btn btn-primary'} 
        ]
    } );
} );
