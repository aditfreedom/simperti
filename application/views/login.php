      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <h6 class="text-center" style="margin-top:5px;"><b>SIMPERTI<br>SISTEM INFORMASI PERIZINAN DAN CUTI KERJA<br>SEKOLAH SUKMA BANGSA BIREUEN</b></h6><br>
            ...
            <?php echo form_open('hal/login_aksi');?>
              ...
              <button class="btn btn-lg btn-info text-light btn-block text-uppercase font-weight-bold rounded-pill" type="submit" ><b>Login</b></button>
              <?php echo form_close();?>
            </div>
        </div>
      </div>
