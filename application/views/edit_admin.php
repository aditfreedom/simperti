<div class="content-wrapper">
    ...
    <div class="container">
            <form method="post" action="<?php echo base_url('home/update_admin'); ?>">
            ...
            ?>
                ...
                <option selected value="<?=$data->role;?>"><?=$role;?></option>
                ...
                <div class="form-group">
                <button type="submit" class="btn text-bold btn-primary form-control" style="height:40px;">UBAH DATA ADMIN</button>                    
                </div>
                <?php endforeach; ?>
